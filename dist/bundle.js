...
function DisplayController() {
  ...
  function displayForecast(forecastWeather) {
    ...
    forecastWeather.forEach(function (day) {
      ...
      var date = newDay.querySelector('.forecast-date');
      var avg = newDay.querySelector('.forecast-avg');
      var picture = newDay.querySelector('.forecast-picture');
      var minMax = newDay.querySelector('.forecast-minMax');
      var ftext = newDay.querySelector('.forecast-text');
      var wind = newDay.querySelector('.forecast-windSpeed-value');
      var humidity = newDay.querySelector('.forecast-humidity-value');
      var prec = newDay.querySelector('.forecast-precipitation-value');
      // console.log({
      //   date,
      //   avg,
      //   picture,
      ...
      var imageAddress = dayData.condition.icon;
      var imageLocal = imageAddress.split('').splice(21).join('');
      console.log(dayData.date);
      date.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(dayData.date, 'do LLLL y');
      avg.textContent = "".concat(dayData.avgTempC, "\xB0C");
      picture.setAttribute('src', "./assets/images/".concat(imageLocal));
      minMax.textContent = "".concat(dayData.maxTempC, "\xB0C/").concat(dayData.minTempC, "\xB0C");
      ftext.textContent = dayData.condition.text;
      wind.textContent = "".concat(dayData.maxWindKph, " Km/h");
      humidity.textContent = "".concat(dayData.avgHumidity, "%");
      prec.textContent = "".concat(dayData.totalPrecipMm, " mm");
    });
  }
    ...
    _displayMainPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(city) {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            (0,_getApiData__WEBPACK_IMPORTED_MODULE_0__["default"])(city).then(function (response) {
              console.log('response ', response);
              var formatData = (0,_FormatData__WEBPACK_IMPORTED_MODULE_1__["default"])(response);
              var currentWeather = formatData.getCurrentWeatherMetric();
              var forecastWeather = formatData.getForecastMetric();
